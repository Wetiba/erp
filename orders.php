...
} else if($_GET['o'] == 'trash') { 
	echo "<div class='div-request div-hide'>trash</div>";
}
...
<div class="panel panel-primary">
	<div class="panel-heading">
		...
		<?php } else if($_GET['o'] == 'trash') { ?>
			<i class="glyphicon glyphicon-edit"></i> Deleted Orders	
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label gst">V.A.T 18%</label>
				    <div class="col-sm-9">
		...
		<?php } else if($_GET['o'] == 'manord') { 
			...
			<table class="table" id="trashOrderTable">
				<thead>
					<tr>
						<th>#</th>
						<th>Order Date</th>
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label gst"><?php if($data[13] == 2) {echo "TOTAL VAT 18%";} else echo "VAT 18%"; ?></label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="gstn" class="col-sm-3 control-label gst">VAT IN</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="gstn" name="gstn" disabled="true" value="<?php echo $data[14] ?>"  />
				    </div>
				  </div><!--/form-group-->		  		  
			  </div> <!--/col-md-6-->
